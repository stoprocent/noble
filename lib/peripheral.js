...
class Peripheral extends EventEmitter {
  ...
  async updateRssiAsync() {
    return new Promise((resolve, reject) => {
      this.updateRssi(error => error ? reject(error) : resolve());
    });
  }
  ...
  async discoverServicesAsync(uuids) {
    return new Promise((resolve, reject) => {
      this.discoverServices(uuids, error => error ? reject(error) : resolve());
    });
  }
  ...
  async readHandleAsync(handle) {
    return new Promise((resolve, reject) => {
      this.readHandle(handle, error => error ? reject(error) : resolve());
    });
  }
