...
NobleBindings.prototype.onSigInt = function() {
  ...
  if (sigIntListeners[sigIntListeners.length - 1] === this.onSigIntBinded) {
    ...
    (function wait () {
      // Wait for outgoing messages queue to drain. This helps with disconnections and reset after int.
      if (this._hci.messageQueueCount() > 0) return setTimeout(wait.bind(this), 100);
      process.exit(1);
    }.bind(this))()
  }
};
